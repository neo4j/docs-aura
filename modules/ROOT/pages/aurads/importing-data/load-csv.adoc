...
We are now ready to load the CSV files from their URIs and create nodes from the data they contain. In the following examples:
...
Similarly to what we have done for nodes, we now create relationships from a CSV file. In the following examples:
