...
Instructions on running the command can be found by clicking on the *Click here* link in the *Import Database* tab or by navigating directly to the https://console.neo4j.io/#import-instructions[Neo4j Aura Console Import page^].
