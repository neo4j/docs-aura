...
* *Export* - Download the database as a *_.tar_* file, allowing you to store a local copy and work on your data offline.
This format bundles both the backup data and the additional metadata required for Graph Data Science.
