...
In this example we use the extended syntax for https://neo4j.com/docs/graph-data-science/2.0-preview/graph-project/#node-projection-syntax[node^] and https://neo4j.com/docs/graph-data-science/2.0-preview/graph-project/#relationship-projection-syntax[relationship^] projections to:

* transform the `EngineeringManagement` and `Developer` labels to `PersonEM` and `PersonM` respectively;
