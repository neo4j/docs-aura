...
TIP: Follow along with a notebook in https://colab.research.google.com/github/neo4j/docs-aura/blob/main/notebooks/Monitoring_the_progress_of_a_running_algorithm_(GDS_client).ipynb[image:colab.svg[Colab,24] Google Colab^]
