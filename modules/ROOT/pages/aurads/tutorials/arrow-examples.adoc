...
. By implementing a custom Arrow Flight client as explained in the link:https://neo4j.com/docs/management-ops/graph-creation/graph-project-apache-arrow/[GDS manual].
