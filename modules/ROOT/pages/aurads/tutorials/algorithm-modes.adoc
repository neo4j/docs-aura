...
TIP: Follow along with a notebook in https://colab.research.google.com/github/neo4j/docs-aura/blob/main/notebooks/Executing_the_different_algorithm_modes_(GDS_client).ipynb[image:colab.svg[Colab,24] Google Colab^]
