...
TIP: Follow along with a notebook in https://colab.research.google.com/github/neo4j/docs-aura/blob/main/notebooks/Persisting_and_sharing_machine_learning_models_(GDS_client).ipynb[image:colab.svg[Colab,24] Google Colab^]
