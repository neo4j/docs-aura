...
TIP: Follow along with a notebook in https://colab.research.google.com/github/neo4j/docs-aura/blob/main/notebooks/Estimating_memory_usage_and_resizing_an_instance_(GDS_client).ipynb[image:colab.svg[Colab,24] Google Colab^]
