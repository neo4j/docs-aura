...
* use the https://neo4j.com/docs/graph-data-science/2.0-preview/common-usage/memory-estimation/[memory estimation^] mode to estimate the memory requirements for an algorithm before running it
