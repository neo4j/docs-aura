...
[NOTE]
====
*Note:* The process of importing or loading data requires you to xref:aurads/getting-started/create.adoc[create an AuraDS database] beforehand.
====
...
For instructions on how to open an AuraDS database with Neo4j Browser, see xref:aurads/getting-started/access.adoc[].
