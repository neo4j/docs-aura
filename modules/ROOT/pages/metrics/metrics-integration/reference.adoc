...
| Description
| The guaranteed baseline CPU cores allocated to your instance.
To optimize performance, your instance is designed to dynamically burst well above this baseline to handle heavy query workloads and peak traffic.
| Metric type
| _Gauge_
| Aggregation method
m| MAX
...
| Description
| Current CPU usage (cores) used for planning and serving queries.
This can safely exceed your guaranteed baseline during peak demand.
If usage is consistently sustained near or above your tier's average allocation, consider upgrading your instance size.
| Metric type
| _Gauge_
| Aggregation method
m| MAX
...
| Description
| The number of active read transactions.
| Metric type
| _Gauge_
| Aggregation method
m| MAX
...
| Description
| The duration of the last checkpoint event in milliseconds.
