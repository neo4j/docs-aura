...
.Query Latency 99th Percentile label:new[Introduced in 5.0]
[frame="topbot", stripes=odd, grid="cols", cols="<1,<4"]
|===
| Metric name
...
.Query Latency 75th Percentile label:new[Introduced in 5.0]
[frame="topbot", stripes=odd, grid="cols", cols="<1,<4"]
|===
| Metric name
...
.Query Latency 50th Percentile label:new[Introduced in 5.0]
[frame="topbot", stripes=odd, grid="cols", cols="<1,<4"]
|===
| Metric name
...
.Cluster Leader (only included if xref:metrics/metrics-integration/introduction.adoc#aura-cmi-metrics-granularity[high granularity] is turned on)
[frame="topbot", stripes=odd, grid="cols", cols="<1,<4"]
|===
| Metric name
