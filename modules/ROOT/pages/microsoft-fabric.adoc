...
At any time during your 14-day trial or up to 14 days after your trial, you can upgrade to a paid plan using one of the following options:
...
. Use the button *Get It Now* and follow instructions to purchase the plan.
