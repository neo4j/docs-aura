...
At any time during or after your 14-day trial, you can upgrade to a paid plan using one of the following options:
...
. Select the button *Get It Now* and follow instructions to purchase the plan.
