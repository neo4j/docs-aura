...
----
+
Note that there are limitations: you *cannot overwrite an AuraDB Free instance with an AuraDB Professional instance* nor can you overwrite an instance that is smaller than the source instance.
+
...
For more information about Customer Managed Keys, see xref:security/customer-managed-keys.adoc[Encryption].
