...
footnote:[Automatic scheduled snapshots run once a day for Professional databases and once an hour for Enterprise databases. Scheduled snapshots are not available for Free databases.] 
