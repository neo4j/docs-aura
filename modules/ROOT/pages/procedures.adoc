...
|❌ Syntax error or access rule violation - invalid number of procedure or function arguments
...
link:https://neo4j.com/docs/cypher-manual/current/genai-integrations/[The GenAI plugin is enabled by default in Neo4j Aura.]
