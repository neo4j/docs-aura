...
As mentioned previously, a project can contain one or more instances.
...
If your instance doesn't contain any data already, the Import service allows you to import CSV files to your database.
...
The tools allow you to interact with your data and thus require an active connection.
...
You can find some metrics around resources directly on the instance card, but all metrics are available in **Metrics**.
...
Access, permissions, and billing is managed at the project level.
