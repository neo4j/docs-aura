...
.Organization settings
[.shadow]
image::organizationsettings.jpg[]
...
By default, the list displays active sessions. You can view past sessions by switching on the "**Include deleted sessions**" toggle.
