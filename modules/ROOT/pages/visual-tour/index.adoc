...
=== Logs
Track Cypher queries with the xref:logging/query-log-analyzer.adoc[Query Log Analyzer.]
Explore security events using the xref:logging/log-forwarding.adoc[Security Log Analyzer] and forward logs to GCP, AWS, or Azure.
You can also download your logs as reports.
