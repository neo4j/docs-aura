...
= Python
:description: This page describes how to connect your application to AuraDB using the Python Driver.
...
Use the following command to install the Python Driver using pip:
