...
It's also possible to connect with SSO. 
For more information see link:https://neo4j.com/docs/operations-manual/current/authentication-authorization/[Operations Manual -> SSO]
