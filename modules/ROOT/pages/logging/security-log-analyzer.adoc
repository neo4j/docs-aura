...
[NOTE]
====
For enabling security log analyzer for Fleet Manager deplyments, see the xref:fleet-management/inspect-deployment.adoc#_security_log_analyzer[deployment settings documentation].
====
