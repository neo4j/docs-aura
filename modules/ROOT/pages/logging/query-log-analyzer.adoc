...
Query log analyzer is similar between Aura instances and self-managed deployments. The differences are that the summary table has
more fields for self-managed deployments that are located in the details tab for Aura instances and the details view is not
