...
[NOTE]
====
For enabling query log analyzer for Fleet Manager deplyments, see the xref:fleet-management/inspect-deployment.adoc#_query_log_analyzer[deployment settings documentation].
====
