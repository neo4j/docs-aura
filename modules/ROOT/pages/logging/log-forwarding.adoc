...
In GCP, logs are forwarded directly to the link:https://docs.cloud.google.com/logging/docs/reference/v2/rest?rep_location=global[Cloud Logging API].
...
In Azure, logs are sent directly to link:https://learn.microsoft.com/en-us/azure/azure-monitor/logs/data-platform-logs[Azure Monitor] of the source data center via the internal endpoint `opinsights.azure.com`.
