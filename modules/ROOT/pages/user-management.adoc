...
| List existing security settings
| {check-mark}
| {check-mark}
|
...
| List security settings on project-level
| {check-mark}
| {check-mark}
|

| Update security settings on project-level
| {check-mark}
| {check-mark}
|

| Delete security settings on project-level
| {check-mark}
| {check-mark}
|
