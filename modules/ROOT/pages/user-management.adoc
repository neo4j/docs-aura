...
| List existing security and networking settings
| {check-mark}
| {check-mark}
|

| Add security and networking settings
| {check-mark}
| {check-mark}
|

| List security and networking settings on project-level
| {check-mark}
| {check-mark}
|

| Update security and networking settings on project-level
| {check-mark}
| {check-mark}
|

| Delete security and networking settings on project-level
| {check-mark}
| {check-mark}
|
