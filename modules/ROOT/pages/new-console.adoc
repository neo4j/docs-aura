...
** *A unified navigation bar* - Allows you to quickly switch between tools like Query and Bloom, to Settings and User management, for example.
...
** *Query and Bloom* are tools for querying and visualizing your data and are now integrated into the console.
...
Co-pilots are available both in the Query and Bloom tools.
