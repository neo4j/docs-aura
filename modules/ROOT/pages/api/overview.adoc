...
AuraDB Free, and AuraDB Professional trial users without a billing method attached to the account get a rate limit of 25 requests per minute.

AuraDB Professional with a billing method attached to the account, AuraDB Virtual Dedicated Cloud, AuraDB Business Critical, and AuraDS Enterprise get a rate limit of 125 requests per minute.