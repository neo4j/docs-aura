...
AuraDB Professional accounts with a billing method attached, AuraDB Virtual Dedicated Cloud, AuraDB Business Critical, and AuraDS Enterprise get a rate limit of 125 requests per minute.