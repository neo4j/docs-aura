...
* *Non-paying customers get a lower rate limit of 25 requests per minute:* This includes AuraDB Free, and AuraDB Professional trial users without a billing method attached to the account.
