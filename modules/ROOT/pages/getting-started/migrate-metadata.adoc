...
If you have an Aura instance created in the classic Aura console, you can migrate the metadata from Workspace to the new console and continue working with your data in the new experience.
...
In the new console, navigate to *Bloom* and open the *Perspective* drawer.
