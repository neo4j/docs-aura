...
Once the instances is created, you *cannot* change this.

You can optionally enable xref:managing-instances/instance-details.adoc#aura-vector-optimization[Vector optimization] to enhance performance for vector-based operations.
