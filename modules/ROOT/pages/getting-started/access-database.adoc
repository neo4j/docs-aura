...
To do this, follow the same process to install the graph application that you need, and open it from Neo4j Desktop or a web browser with the running and activated Neo4j AuraDB instance.
