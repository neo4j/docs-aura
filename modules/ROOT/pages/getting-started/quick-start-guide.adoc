...
* **AuraDB**, the fully managed cloud graph database service
...
* xref:managing-instances/instance-details.adoc#aura-gds-plugin[Graph Data Science plugin] to add the Graph Data Science library (**AuraDB only**)
