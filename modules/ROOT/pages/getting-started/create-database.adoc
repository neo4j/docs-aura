...
The process of creating a database differs depending on your subscription plan and the type of database you want to create. 

Select from the options below to display the relevant process.
...
To create a free database in Neo4j Aura:
...
To create a professional database in Neo4j Aura:
...
To create an enterprise database in Neo4j Aura:
