...
With your Aura database created, you can import data into it by following the steps outlined in xref:importing-data/index.adoc[Importing data].

Alternatively, for more information on how to manage your database, see the xref:managing-databases/monitoring.adoc[Managing databases] section.
