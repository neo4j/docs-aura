...
The consumption report shows the billing status, which can be `running` meaning customers are charged the full price, or `ended` meaning customers are charged 20% of the hourly rate.
