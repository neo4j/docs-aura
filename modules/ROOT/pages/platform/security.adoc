...
You can also choose whether traffic to your Aura instance is allowed to traverse the public internet or if it should use the cloud provider's internal network. 
