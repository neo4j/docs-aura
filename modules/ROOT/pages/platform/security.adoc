...
GCP's Cloud Key Management is now in public beta, contact Aura Support to join.
...
After you have initially created the a key in the AWS KMS, you can edit the key policy.
...
Although automatic rotation is not enforced by Aura, it is best practice to rotate keys regularly. We do not recommend you rotate a key manually. 
