...
* *Details* - A detailed view showing individual query execution in the selected time period. 
...
Columns can be [en|dis]abled or the order changed using the grid icon at the top right of the table.
