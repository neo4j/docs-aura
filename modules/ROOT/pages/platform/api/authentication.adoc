...
In the *Account Details* section of the Aura console, Aura API credentials refer to OAuth clients (Client ID and Client Secret). These credentials do not expire unless deleted and are used to generate access tokens, which do expire.
