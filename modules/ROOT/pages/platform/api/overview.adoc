...
A complete list of the available endpoints can be seen and tested in the link:{neo4j-docs-base-uri}/aura/api/specification/[API Specification].
...
The current version of the Aura API  is `link:{neo4j-docs-base-uri}/aura/api/specification/?urls.primaryName=Aura%20v1beta3[v1beta3]`

[NOTE]
====
`V1beta3` indicates that this is the third beta release of V1 of the Public API. 
