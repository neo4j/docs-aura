...
The current version of the Aura API  is `link:{neo4j-docs-base-uri}/aura/platform/api/specification/[v1beta4]`

[NOTE]
====
`V1beta4` indicates that this is the fourth beta release of V1 of the API. 
...
`GET \https://api.neo4j.io/v1beta4/instances`
