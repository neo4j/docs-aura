...
Starting 27 Jan 2025, rate limiting for the `/oauth/token` endpoint will be adjusted to 15 requests per hour.
...
You can optimize your API usage in advance by following these steps:
