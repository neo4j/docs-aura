...
Aura Virtual Dedicated Cloud and Aura Business Critical supports Single Sign-On (SSO) at both the Console level and for accessing Workspace, Bloom and Browser clients directly at the instance level.
...
To add SSO for Workspace, Bloom, and Browser to your Aura Virtual Dedicated Cloud instances, please https://support.neo4j.com/[raise a support ticket] including the following information:
