...
Organization owners and admins can configure one or more SSO login methods.
...
You can configure Organization SSO or Instance SSO. 

Role mapping only applies to Instance SSO.
