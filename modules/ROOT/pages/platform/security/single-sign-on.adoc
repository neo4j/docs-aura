...
The following OpenID connect (OIDC) certified Identity Providers (IdPs) are currently supported for Console-level Authentication with Aura Enterprise:

* Microsoft Entra ID
* Okta

The following OIDC IdPs are currently supported for Console-level Authentication with Aura Business Critical:
