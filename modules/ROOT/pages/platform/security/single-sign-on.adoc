...
Use the check boxes to "Use as a log in for the Organization" or "Use as login method for instances with projects in this Org".
You can check both check boxes, for Organization and Instance access here.
