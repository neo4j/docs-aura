...
* *Org SSO:* Just because you can login via org SSO doesn't mean you have access to the org. 
You still have to be invited and the invitee will grant you a role when you are invited and that dictates if you can edit settings or view/manage instances. 
Org SSO allows org admins to restrict how users login when they are trying to access the org. 
Everything else around access is managed via roles (RBAC) and invites.
