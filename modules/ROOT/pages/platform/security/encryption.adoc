...
*Multi-region key*
Multi-region keys have a main region, however these can be replicated to other regions that match the region of your Aura instance. The replicas share the same key ID and different ARNs with the main key.
