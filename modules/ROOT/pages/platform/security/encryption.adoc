...
When managing a Customer Managed Key within Aura, it's important to note that if this key is currently being used to encrypt one or more Aura database instances, it cannot be removed from within Aura.
