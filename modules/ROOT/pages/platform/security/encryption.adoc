...
If the same CMK does not exist in the destination region and product, the cloned instance must be encrypted with a available CMK for that region and product, which you can choose.
