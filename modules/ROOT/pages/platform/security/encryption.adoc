...
In the Azure portal, add role assignment by selecting relevant members as *Key Vault Crypto Officer*.
Use the Neo4j CMK Application ID from the Aura Console.