...
* The Azure CLI command you need to run is `az ad sp create --id clientID`
* For more information see the link:https://learn.microsoft.com/en-us/cli/azure/ad/sp?view=azure-cli-latest#az-ad-sp-create-examples[Microsoft documentation for Azure CLI]
