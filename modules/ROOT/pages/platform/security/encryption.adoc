...
** Allow public access from all networks (no need to check “Allow trusted Microsoft services to bypass this firewall” )
...
* If you need to edit the public access setting after setting up the key vault, you will find public access options in Networking > Firewalls and Virtual Networks and below it is the Exeption section where you will find the checkbox “Allow trusted Microsoft services to bypass this firewall”.
