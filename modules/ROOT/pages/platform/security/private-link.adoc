...
For example, http://abcd1234.production-orch-0000.neo4j.io/
...
Then it will check the private link, to check the private DNS address for the AFQDN.

Then the private DNS will tell the application to go to the IP address of the endpoint. 
Then this endpoint will forward everything to Aura. 
