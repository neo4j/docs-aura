...
IMPORTANT!! Make sure they are using the private link!!
https://support.neo4j.com/s/article/13174783967507-How-To-Test-Connectivity-Through-The-Private-Endpoint[test endpoint]
...
. You can monitor the status of your PrivateLink configuration in the Aura Console.
