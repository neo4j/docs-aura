...
*Obtain Private Link Service Name*

. After enabling Private Link, you receive a PrivateLink service name in the Aura console.
...
. Use the Private Link service name obtained in the previous step for the configuration.
