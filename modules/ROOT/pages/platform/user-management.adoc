...
_Members_ can do everything _Viewers_ can do, plus:

* Perform all actions on instances. 
footnote:[Actions include creating, deleting, pausing, resuming and editing instances.]
* Clone data to new and existing instances.
* Take on demand snapshots.
* Restore from snapshots.

_Admins_ can do everything _Members_ can do, plus:

* Invite new users to the team.
* Edit existing team member's roles.
