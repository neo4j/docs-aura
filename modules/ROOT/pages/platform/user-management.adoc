...
* Edit the name of the tenant you are currently viewing by selecting the pencil icon next to the tenant.
This action requires you to be an _Admin_ of the tenant.
