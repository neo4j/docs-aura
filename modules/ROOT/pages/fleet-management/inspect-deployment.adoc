...
* *Release* — This deletes the association between this deployment and the current Neo4j cluster. 
This allows another cluster to claim the deployment which can be especially useful when migrating to a new major Neo4j version. 
