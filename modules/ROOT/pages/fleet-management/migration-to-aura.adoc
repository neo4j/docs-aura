...
[TIP]
====
Before migrating your database, consider creating a defragmented copy of your database.
...
If you migrated from a Community Edition deployment its likely that your database is not on block format.
...
See link:https://neo4j.com/docs/operations-manual/current/database-internals/store-formats/[Store formats] for more information about the block store format.
