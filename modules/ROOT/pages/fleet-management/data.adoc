...
Message sent from the plugin to the Fleet Manager service to establish a connection.
...
Message sent from the plugin to the Fleet Manager service containing metrics data.
...
Message sent from the plugin to the Fleet Manager service containing neo4j configuration data.
...
Message sent from the plugin to the Fleet Manager service to retrieve configuration updates.
...
Message sent from the plugin to the Fleet Manager service containing reporting data.
