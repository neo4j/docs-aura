...
Message sent from the server to the Fleet Manager service containing aggregated query data.
Only sent if query logging is enabled explicitly through Aura Console.
