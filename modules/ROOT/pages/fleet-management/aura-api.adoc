...
** The latest versions of Neo4j ship with Fleet Manager built-in. Documentation for installing the Fleet Manager plugin in older versions of Neo4j: xref:./setup.adoc#_setup_using_plugin_neo4j_4_4_x_5_26_x_2026_03_0[Plugin setup]
