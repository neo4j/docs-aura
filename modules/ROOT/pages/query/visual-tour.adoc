...
When you use the *Save and open in tab* button, the query in the editor is saved to this drawer, even after the tab is closed.
When you open a query from this drawer, it opens in a new tab.
If you open a new tab to write a new query, it is saved as a draft.
It remains a draft until you

[.shadow]
image::save-tab.png[width=300]

From here, you can organize your saved queries, download or upload these, or delete them if needed.

[.shadow]
image::query-drawer.png[width=400]
