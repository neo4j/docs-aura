...
This option allows you to express a parameter type and have it evaluated by the server as Cypher, much like using the `:param` command, as described in the following section.
