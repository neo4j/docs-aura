...
* Right-click a node to bring up the *context menu*.
From the context menu, you can *expand/collapse* the node, *dismiss* or *unpin* it, *explore* the graph with *Bloom*, and *show all relationships*.
You can also undo context-menu actions, when applicable.
+
[.shadow]
.Context menu
image::query-context-menu.png[width=300]
+
...
* Right-click in an empty spot brings up another *context menu*.
This allows you to *explore* the graph with *Bloom*, *show all relationships*, and undo previous actions from the context menu, when applicable.
