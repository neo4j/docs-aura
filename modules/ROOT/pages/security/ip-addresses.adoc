...
*Instances with specific cloud providers and regions:* Your Aura instances and their respective regions, for example an  instance in `us-east-1`, AWS.
...
The public IP address of your AuraDB or AuraDS instance depends on both the cloud provider region and the Aura tier.
...
[cols="1,1,1"]
|===
|Region |Aura Professional IPv4 Address |Ports (TCP)
