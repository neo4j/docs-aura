...
[NOTE]
====
For Microsoft Entra ID users, the Entra group name can not be used but rather the UUID should be used.

For Azure, the role mapping should look something like:
