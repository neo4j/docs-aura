...
[NOTE]
====
Customer support isn't required for all SSO, just certain setups. For example, support can help you configure instance-level SSO for individual instances.

Also note that SSO configuration changes are not applied retroactively.
...
* Adding link:https://auth0.com/docs/secure/tokens/json-web-tokens/create-custom-claims[custom claims] beyond `groups`
