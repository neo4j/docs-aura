...
[NOTE]
====
SSO configuration changes are not applied retroactively.
To apply updated SSO settings or role mappings to an existing instance, contact Neo4j Support for assistance.
====
