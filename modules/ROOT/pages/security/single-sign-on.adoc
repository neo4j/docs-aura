...
. Go to xref:visual-tour/index.adoc#org-settings[Organization] > *Security* > *Single Sign-On* to set up a new SSO configuration.
...
. In the Aura console, go to xref:visual-tour/index.adoc#org-settings[Organization] > *Security* > *Single Sign On* > *New configuration*.
