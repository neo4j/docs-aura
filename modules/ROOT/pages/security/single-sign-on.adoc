...
3. The required basic SSO configuration information can be retrieved from the IdP.
...
To verify that single sign-on is working:

.Visit Neo4j Console.
.On the login page, you should see a Login with SSO button.
.Click Login with SSO to be redirected to your Identity Provider’s (IdP) login portal.
.If you are already logged in with your IdP, you will be automatically redirected back to the Aura console.
.If you are not logged in, enter your credentials to log in.
.After a successful login, you should be redirected to the Aura console.
.To confirm that SSO is active, you will see your SSO profile in the upper right hand corner of the console.
