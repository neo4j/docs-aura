...
It only changes the name displayed in the Aura connection dialog.
For example, changing the display name from *Docs SSO* to *Neo4j Dev* updates the button shown when users connect to the instance.
