...
== Features requiring customer support

It is mandatory to go through support for: 

* Authorization code and PKCE flow for users
* Device authorization flow for users
* Client credentials flow for apps
* Customisation of the instance callback URI when using a private endpoint
