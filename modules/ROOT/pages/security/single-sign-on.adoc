...
* Authenticates users so they can log into the Neo4j Aura Console UI (console.neo4j.io). Conceptually the user is logging into the Management Plane.
...
Conceptually the user is logging into the Data Plane.
