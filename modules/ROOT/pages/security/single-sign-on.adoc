...
*Can users get roles added to them in Console via Console/Organization SSO and a group to role mapping?*

No, users must be granted the role on the org via Console invites and access management like with any other organization.
