...
To continue accessing these tools, connect via HTTPS (port 443), this is helpful when network security blocks Bolt (port 7687), 
e.g. when a private link is set up on the database with public traffic disabled. 
Alternatively you can set up a VPN in your VPC and connect to Query and Explore over the VPN.
