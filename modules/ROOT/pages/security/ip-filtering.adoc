...
The link:https://neo4j.com/docs/aura/platform/api/specification/?urls.primaryName=Aura%20v2beta1#/[Aura API `v2beta1`]:

* Returns a list of IP filters for an instance
* Returns a list of IP filters for the organization
* Creates a new IP filter for the organization
* Returns a specific IP filter of the organization
* Updates an existing IP filter
* Deletes an existing IP filter
