...
When you have enabled private endpoints and disabled public internet access, to continue accessing Query and Explore, you can either connect via HTTPS (port 443), or use a private endpoint.
