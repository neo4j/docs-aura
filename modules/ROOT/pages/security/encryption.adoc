...
[IMPORTANT]
====
Create the *symmetric* key in AWS.
Aura does not support asymmetric keys.
====

. Create the *symmetric key* in the AWS KMS making sure the region matches your Aura database instance. 
...
[IMPORTANT]
====
Create the *symmetric encrypt/decrypt* key in GCP. 
Aura does not support asymmetric keys.
====

. Create the *symmetric encrypt/decrypt* key in the Google Console.
