...
Internal agents are free to use, but once you make an agent external, it incurs charges per link:https://console.neo4j.io/pricing/?version=1.4#:~:text=gcp.ds_paused.1952gb-,Aura%20Agent%20hours,-All%20tiers[Neo4j Aura Pricing].
