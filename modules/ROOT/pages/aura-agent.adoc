...
Keep in mind that currently the agent only supports *read only* queries against the database. INSTANCE-DATABASE-DEFINITION-REVIEW
...
This tool executes pre-defined, parameterized Cypher queries against the database and returns the results to the agent. INSTANCE-DATABASE-DEFINITION-REVIEW
