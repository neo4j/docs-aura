...
[NOTE]
======
If you have yet to create a Free instance, you will always be presented with the option to do so. If you still wish to create a professional instance, select *Select Professional instance* and follow the instructions below from step 3 onwards.
======
