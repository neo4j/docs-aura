...
RDFLib is a link:https://neo4j.com/labs/[Neo4j Labs] project which allows the import of RDF data (which can include JSON-LD) to Aura via a Python library.
(Please note: This project is likely not supported by Neo4j engineering, and could become out of date without the docs team being notified.)
