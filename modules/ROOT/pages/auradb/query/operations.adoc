...
To change what your graph looks like, see xref:operations/browser-styling.adoc[].
...
Parameters are not saved when you close Query.
You can save a `:params` command to your Saved Cypher to quickly populate parameters again.