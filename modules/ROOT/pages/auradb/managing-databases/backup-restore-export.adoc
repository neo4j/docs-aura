...
By selecting the ellipses (…​) button next to a snapshot, you can create an instance from a snapshot.
The *Create instance from snapshot* button creates a new AuraDB instance using the data from the snapshot. 
Effectively, it creates a clone of the instance. 
