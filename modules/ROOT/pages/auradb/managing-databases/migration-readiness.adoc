...
[NOTE]
====
In the Migration Readiness Report we only highlight issues that need to be changed to make your code and queries compatible with AuraDB v5.
While you are working on this, we would also encourage you to extend this work to take advantage of the new v5 features.
====
