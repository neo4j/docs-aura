...
[NOTE]
====
During the migration, the migration target instance might be shown with a few different status on the instance page like LOADING or OVERWRITING. Do not access the instance before the migration is safely finished. Please check the Migration Readiness Report of the old instance.
====
...
For the purpose of this migration process and to save cost for the user, the test instance should be removed after manual testing is done. You can also choose to skip this step and keep the test instance as long as you want.
