...
* Once you are done with testing, click the "Finalize test migration" and complete the dialog box to remove your test instance.
...
[NOTE]
====
During the migration, the new instance might be shown with a few different status on the instance page like LOADING or OVERWRITING. Do not access the instance before the migration is safely finished. Please check the Migration Readiness Report of the old instance.
====
...
Use the "Live migration" buttons at the top or bottom of the page and then follow the steps outlined in the dialog boxes. The process for a live migration is very similar to the test migration. To avoid unnecessary repetition, only the additional and changed steps and details will be documented here.