...
:page-role: aura-db-professional aura-db-dedicated aura-db-business-critical
...
* label:AuraDB-Virtual-Dedicated-Cloud[] *Heap Usage (%)* _Only available on AuraDB Virtual Dedicated Cloud_ - The amount of Java Virtual Machine (JVM) memory used by the instance as a percentage. 
