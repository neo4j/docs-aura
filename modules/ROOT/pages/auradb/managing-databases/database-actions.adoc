...
One-step downward resizing is supported, allowing you to resize instances downwards as long as the selected instance size has enough storage capacity for the data.
