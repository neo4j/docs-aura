...
Perform multiple instance actions from an instance card. 
...
|ID
|Every instance has with an ID which is a unique identifier. It means multiple instances can have the same instance name.
