...
Recreating users and roles is recommended step after cloning your database from one instance to a new Aura instance as metadata will not get copied with cloning.
