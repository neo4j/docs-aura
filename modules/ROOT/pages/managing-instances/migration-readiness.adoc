...
It is highly recommended to do this, as it will enable you to make use of the newest features in Neo4j Aura as well as its superior performance and scalability.
