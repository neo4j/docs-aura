...
After completing the migration, make sure to recreate users, roles, and privileges in the new instance. For detailed steps, see xref:tutorials/upgrade.adoc#_recreate_users_and_roles_in_neo4j_aura[Recreate users and roles in Aura].