...
[NOTE]
====
Index replacements created using the provided UI will be of type RANGE. To create replacements of other types (e.g. TEXT or POINT), change the provided Cypher query appropriately.
====
