...
This configuration re-allocates memory to the vector index at the expense of non-vector query performance. 
If this has a negative impact on your application, consider resizing your Aura instance.

To enable vector optimization during instance creation, select *Instance details* then *Additional settings*. 
