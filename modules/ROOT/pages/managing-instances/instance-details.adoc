...
Although you can use the GDS plugin as an alternative to an AuraDS instance, there are important operational differences between the two deployment modes.
