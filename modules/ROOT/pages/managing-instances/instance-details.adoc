...
If your instance supports multiple databases, you can create additional databases. See  xref:managing-instances/multiple-databases.adoc[Multiple databases]
