...
The Graph Data Science plugin requires approximately 300mb of memory when running or paused, therefore you can enable or disable the plugin when necessary. 

For more information, read the https://neo4j.com/docs/graph-data-science/current/introduction/[The Graph Data Science documentation].
