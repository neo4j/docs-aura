...
The Graph Data Science plugin allows you to access the link:https://neo4j.com/docs/graph-data-science/current/introduction/[Graph Data Science library] in any AuraDB instance with the following requirements:
...
==== Comparison with AuraDS

Although you can use the GDS plugin with an AuraDB instance as an alternative to an AuraDS instance, there are important operational differences between the two deployment modes.
