...
|MCP URL
|Use this to connect to an instance with an MCP client
...
It runs on container technology and this allows for the AuraDB Instance to allocate a maximum of dedicated vCPU resources.
