...
Storage is adjustable independent of memory for AuraDB pre-paid plans on Google Cloud (GCP), Neo4j latest version. See xref:managing-instances/instance-actions.adoc#_adjustable_storage[Adjustable storage] for more information.
