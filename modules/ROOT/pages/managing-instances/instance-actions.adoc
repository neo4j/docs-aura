...
When you resume the instance, you can pick up where you left off.
...
----
For more information, see the link:https://neo4j.com/docs/aura/platform/api/specification/?urls.primaryName=Aura%20v1#/instances/post-pause-instance[Aura API specification].
=====
====
...
----
For more information, see the link:https://neo4j.com/docs/aura/platform/api/specification/?urls.primaryName=Aura%20v1#/instances/post-resume-instance[Aura API specification].
=====
====
...
If you need the data later, xref:/managing-instances/backup-restore-export.adoc#_on_demand[take a snapshot] before deleting the instance.
====
...
----
For more information, see the link:https://neo4j.com/docs/aura/platform/api/specification/?urls.primaryName=Aura%20v1#/instances/delete-instance-id[Aura API specification].
=====
====
...
[.include-with-Aura-console]
=====
From  the more menu *[...]* on the instance card, select *instance details*.
You can rename an instance and view instance details among other things.
...
----
For more information, see the link:https://neo4j.com/docs/aura/platform/api/specification/?urls.primaryName=Aura%20v1#/instances/get-instance-id[Aura API specification].
=====
====
...
Cloning duplicates data from one Aura instance (source instance) to another instance (destination instance). Clone to an existing instance or a new instance.
...
Clone using the Aura console. 
Cloning is not available through the Aura API.
...
Cloning to a new instance creates a brand new destination instance containing a duplicate of the source instance data.

. From the more menu (*...*) on the source instance select *Clone to* > *New instance.*
. Configure the new instance including the required options under *Cloud provider & region*.
For more information, see xref:getting-started/create-instance/[Create an instance].
. The next screen will display the new instance credentials. Select *Download* and *Continue*.
...
An existing instance is a destination instance that was already created before you started cloning. The destination instance can be empty or contain data. 

[WARNING]
====
If there is data in the destination instance, the source instance data replaces the destination instance data.
Export a snapshot of the destination instance before cloning to back it up.
====
...
----
For more information, see the link:https://neo4j.com/docs/aura/platform/api/specification/?urls.primaryName=Aura%20v1#/instances/post-upgrade-instance[Aura API specification].
=====
====
