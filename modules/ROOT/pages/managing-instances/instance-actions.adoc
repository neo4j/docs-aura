...
----
For more information, see thelink:https://neo4j.com/docs/aura/platform/api/specification/?urls.primaryName=Aura%20v1#/instances/post-upgrade-instance[Aura API specification].
=====
====
