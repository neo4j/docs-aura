...
This returns the instance details, including:
...
Tiers and prices are described in: https://neo4j.com/pricing/[Neo4j.com/pricing]

An upgrade does not change the original instance ID, so your application strings remain valid.
