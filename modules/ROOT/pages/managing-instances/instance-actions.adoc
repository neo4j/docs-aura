...
[NOTE]
====
Available for all AuraDB tiers on the latest Neo4j version — with PAYG (direct), Prepaid on AWS, Azure and GCP, and GCP Marketplace PAYG for new subscriptions after October 19, 2025.
====
