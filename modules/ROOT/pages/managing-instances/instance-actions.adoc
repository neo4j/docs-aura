...
If the instance is set up to contain multiple databases, you can create new databases from the *databases* tab. 
For more information, see xref:managing-instances/multiple-databases.adoc[Manage multiple databases].
