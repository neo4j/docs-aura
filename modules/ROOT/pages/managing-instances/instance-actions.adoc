...
[NOTE]
====
Available for AuraDB Professional, Business Critical & Virtual Dedicated Cloud deployments on GCP, with PAYG Direct or Prepaid billing, Neo4j latest version.
====
