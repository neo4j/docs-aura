...
. Configure the new instance including the required region under *Cloud provider & region* and confirm with *Create instance*.
. Save the credentials and *Continue*.
...
The destination instance progresses through states, including *Loading*.
