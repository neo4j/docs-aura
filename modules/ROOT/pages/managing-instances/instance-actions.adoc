...
From the instance details you can rename an instance, view instance details and we explain them in the link:https://neo4j.com/docs/aura/preview/managing-instances/instance-details/[instance details docs.]
