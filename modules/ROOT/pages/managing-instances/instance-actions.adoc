...
----
For more information, see link:https://neo4j.com/docs/aura/platform/api/specification/?urls.primaryName=Aura%20v1#/instances/post-pause-instance[Aura API spec]
=====
====
...
----
For more information, see link:https://neo4j.com/docs/aura/platform/api/specification/?urls.primaryName=Aura%20v1#/instances/delete-instance-id[Aura API spec]
=====
====
