...
All Neo4j tiers share the same advanced graph database technology that helps you uncover hidden patterns and relationships in connected data. 
However, features, support levels, and management requirements differ to address different use cases and organizational needs.
