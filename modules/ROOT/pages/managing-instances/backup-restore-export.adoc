...
* *Export* - Download the *AuraDB* instance as a *_.backup_* file (for latest version) or *_.dump_* (for version 4.x) or the *AuraDS* instance as a *_.tar_* file, allowing you to store a local copy and work on your data offline.
