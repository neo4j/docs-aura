...
From the more (*...*) menu next to an existing snapshot, you can create an instance from a snapshot.
*Create instance from snapshot* creates a new AuraDB instance using the data from the snapshot. 
