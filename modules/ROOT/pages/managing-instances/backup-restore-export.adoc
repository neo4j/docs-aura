...
* Instances running deprecated Neo4j versions can be suspended. Suspension is lifted after upgrading to a supported Neo4j version.

* Instances can be suspended because of unpaid invoices. Suspension is lifted after outstanding invoices are paid.
