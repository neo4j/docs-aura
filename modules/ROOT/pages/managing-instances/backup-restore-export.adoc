...
For instances with multiple user databases, you can restore a database from a backup file from the *Databases* tab.
Use the *[...]* menu on the database you want to restore.
