...
[NOTE]
====
It is not supported to restore from a link:{neo4j-docs-base-uri}/operations-manual/current/backup-restore/planning/#splitting-backup-archive[split backup archive] introduced in Neo4j 2026.09.
====
