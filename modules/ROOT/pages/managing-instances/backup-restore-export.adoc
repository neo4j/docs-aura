...
For Professional instances, scheduled snapshots are run automatically once a day, same for AuraDS instances, and for Business Critical and Virtual Dedicated Cloud instances, they run once an hour.
