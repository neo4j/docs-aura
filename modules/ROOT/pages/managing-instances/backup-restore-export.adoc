...
Scheduled snapshots are available for 30 days for Professional instances, Business Critical instances, and 60 days for Virtual Dedicated Cloud instances.
Snapshots of AuraDS Professional instances are available for 30 days and AuraDS Enterprise instances' snapshots for 60 days.
...
For Professional instances, scheduled snapshots are run automatically once a day, same for AuraDS Professional instances, and for Business Critical and Virtual Dedicated Cloud instances, they run once an hour, as for AuraDS Enterprise instances.
