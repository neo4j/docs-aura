...
However, you can *restore a whole instance*, as described in <<Multi-database instance restore>> below.
...
See <<Multi-database instances restore>> for information on how to restore the whole instance.
