...
For more information on how to recover a backup, see link:{neo4j-docs-base-uri}/operations-manual/current/backup-restore/aggregate/#aggregate-unrecovered-full-backup[Operations Manual -> Aggregate an unrecovered full backup].
====
