...
[NOTE]
====
Any backups exported from Aura will be unrecovered.
For more information on how to recover a backup, see link:{neo4j-docs-base-uri}/operations-manual/current/backup-restore/aggregate/[Operations Manual -> Aggregate a backup chain].
====
