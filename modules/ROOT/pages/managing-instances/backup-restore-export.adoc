...
:description: This page describes how to backup, export, and restore your data from a snapshot asw ell as using `neo4j admin` to upload data.
...
If you have a local copy of a Neo4j database, you can use your local installation of Neo4j to upload this to your Aura instance.
