...
Graph Analytics Serverless runs in Aura as a link:ttps://neo4j.com/docs/graph-data-science/current/installation/gds-sessions/[dedicated service] optimised for analytics workloads, with no memory or compute resources shared with your data store.
