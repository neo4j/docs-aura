...
[IMPORTANT]
====
Aura Graph Analytics is available via the GCP marketplace and for pay-as-you-go customers, but is currently unavailable via the AWS and Azure xref:cloud-providers.adoc[marketplace]
====
