...
[IMPORTANT]
====
Aura Graph Analytics is available via the GCP marketplace and for pay-as-you-go customers, but is currently *not* available via either the AWS or the Azure xref:cloud-providers.adoc[marketplaces].
====
