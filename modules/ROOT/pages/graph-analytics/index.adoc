...
{gds-no-db-name} allows you to use the link:https://neo4j.com/docs/graph-data-science/current/introduction/[Graph Data Science library] in Aura without AuraDB or AuraDS, on any supported cloud providers and regions.
