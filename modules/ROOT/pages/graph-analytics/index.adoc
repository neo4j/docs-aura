...
[IMPORTANT]
====
Aura Graph Analytics is available via the GCP marketplace and for pay-as-you-go customers, but is currently *not* available via the Azure xref:cloud-providers.adoc[marketplace].
====
