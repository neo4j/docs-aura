...
[IMPORTANT]
====
You cannot use Graph Analytics Serverless if you have purchased AuraDB Business Critical via any of the xref:cloud-providers.adoc[cloud provider marketplaces].
====
