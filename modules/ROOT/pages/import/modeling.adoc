...
This ID is useful if you intend to import via the link:{neo4j-docs-base-uri}/aura/platform/api/specification/?urls.primaryName=Aura%20v2beta1#/[API], but doing so requires a complete model with data source and mapping.
