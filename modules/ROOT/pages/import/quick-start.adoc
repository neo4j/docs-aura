...
These refelct the three stages of importing data; provide the data, i.e. configure a source to fetch the data from, model the data, i.e. how is the data organized, and finally, run the import.
