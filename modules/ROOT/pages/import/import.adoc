[[import]]
:description: This section describes how to do the actual import of data with Neo4j Import.
= Run the import
...
=== Import to an instance with multiple databases

If your instance contains multiple databases, select the target database before running the import.
The import is applied to the selected database.
