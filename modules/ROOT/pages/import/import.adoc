...
If your instance contains xref:managing-instances/multiple-databases.adoc[multiple databases], you are prompted to select the target database before running an import.