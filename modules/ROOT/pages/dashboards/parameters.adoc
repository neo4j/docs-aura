...
Use parameters in Cypher queries, card titles, descriptions, and Markdown text. 
When the parameter value changes, the displayed text updates automatically.

The parameters drawer lets you adjust values that shape your dashboard results.
Open the parameters drawer using the link:https://neo4j.com/docs/aura/dashboards/parameters-and-filters/#_step_1_open_the_parameters_drawer[open the parameters drawer] curly brackets icon `{}` on the top right of a dashboard.
