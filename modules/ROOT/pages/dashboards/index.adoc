...
[NOTE]
====
To access dashboard GenAI features, an organization admin must enable Generative AI assistance in xref:visual-tour/index.adoc#org-settings[Organization Settings].
====
