...
Invite individual users from your project or share your dashboard with everyone in the project.
...
You can grant users edit access as `Viewers` or `Editors`. Filters are a useful dashboard feature that allow `Viewers` to adjust parameter values.
