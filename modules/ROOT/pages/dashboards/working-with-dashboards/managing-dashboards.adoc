...
See xref:dashboards/advanced-features/parameters-and-filters.adoc#_filters[filters] for more information.
...
See xref:dashboards/advanced-features/parameters-and-filters.adoc#_parameters[parameters].
