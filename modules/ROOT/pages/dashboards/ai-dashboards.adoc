...
It's fun to use AI as a starting point, and then build on the output by editing the output.
Use AI as a starting point, then refine visualizations, colors, and layouts to match your needs.
