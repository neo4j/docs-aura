...
. *Review your dashboard plan*:  this will show you the layout of your new dashboard. 
. You can type in the text box to change/refine the plan. Refining the layout of the charts etc. 
. Again, press the ✨ to reload based on your suggestions.
. When things are looking the way you like, select **Create dashboard**. You can always edit things later when the dashboard is generated. 
