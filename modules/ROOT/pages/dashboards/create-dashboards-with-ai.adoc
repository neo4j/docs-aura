...
. In the **Create with AI** dialog, you can enter an optional natural language text prompt.
. Pick from the suggested ideas. Or, write your own suggestions in the text box, then press the AI button ✨ to reload the suggested ideas.
. Once you are happy with the prompt, select *Continue*. 
. *Review your dashboard plan* will show you the layout of your new dashboard. 
. You can type in the text box to change the plan, you can enter more prompts and press the ✨ to reload based on your suggestions.
. When things are looking the way you like, select **Create dashboard**. 
