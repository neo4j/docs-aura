...
. Pick from the suggested ideas. Or, write own suggestions in the text box, then press the AI button ✨ to reload the suggested ideas.
. Once you are happy with the prompt, select *Continue*. 
. The *Review your dashboard plan* will show you the layout of your new dashboard. 
