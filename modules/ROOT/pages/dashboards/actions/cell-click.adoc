...
The cell click action is available for xref:dashboards/visualizations/table.adoc[Table] visualizations.
...
[NOTE]
====
A cell click action will always set a parameter and optionally navigate to a dashboard page or an external URL.
====

Use cell click actions to:
...
For example, a URL like `name=John` exposes personal information directly.
