...
Use a dashboard to see the stats you need, or filter your data.
...
. Create a parameter from the parameter drawer
. Create a parameter when you add a filter
...
Let's take the parameter we created in Example 1
If we take the existing $unit_param we made earlier.
