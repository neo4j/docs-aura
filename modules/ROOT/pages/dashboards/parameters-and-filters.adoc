...
You might want to do different kinds of filtering e.g. filter by date, to select a number value, or select a free text value. 
...
. You'll see the parameter icon '{}' at the top right of the screen and when you select it, it opens the **Parameters** drawer.
