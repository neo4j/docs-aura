...
This ensures that the property must be unique and not null and to achieve that, a corresponding composite range index is also created to support that constraint.
