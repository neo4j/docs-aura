...
The billing dimension for Aura Graph Analytics sessions is compute and it is measured in GB-minutes.
...
=== GraphQL example: 
You set up a GraphQL API with 256MB of RAM, every hour the database is running will trigger a usage record of 256 MB-hours.
