:description: This section presents tips for a quicker start with Bloom.
[[explore-quick-start]]
= Quick start

Bloom is designed to be simple and intuitive enough for a business person or knowledge worker to pick up and use.
...
Additionally, Bloom needs a xref:explore/explore-perspectives/perspectives.adoc[Perspective] as a business view of the graph to which it connects.
