...
When you run graph algorithms in Explore, these either run in a separate compute environment via xref:graph-analytics/aga.adoc[Aura Graph Analytics], or they run in your instance using the Graph Analytics plugin, sharing both memory and compute with your database.
