...
When you run graph algorithms in Explore, these either run in a seprate compute environment via the serverless option, or they run in your instance using the Graph Analytics plugin, sharing both memory and compute with your database.
