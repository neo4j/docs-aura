...
:description: This section describes Scenes and how to export data from Bloom in the Neo4j Aura console
...
To avoid the loss of saved Scenes, make sure to export your saved Scenes prior to pausing your instance, as described below.
====
