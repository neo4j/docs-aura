:description: This section gives a short introduction to the Bloom tool.
[[explore-introduction]]
= Bloom

The Bloom tool, powered by Neo4j Bloom, is a graph exploration tool for visually interacting with graph data.

A graph puts information into context.
People, places, and things.
Products, services, and accounts.
Transactions, identities, and events.
Bloom shows the patterns you intuitively know are there in your data, and reveals new patterns you may not have expected.

[[explore-features]]

The core set of Bloom features are:
...
Bloom exists as a standalone tool as well, _Neo4j Bloom_.
