:description: This section describes Perspectives in Bloom.

[[perspectives]]
= Perspectives

In Bloom, a Perspective defines a certain business view or domain that can be found in the target Neo4j graph.
...
After connecting to the instance that contains this Neo4j database and launching Bloom for the first time, Bloom automatically generates a Perspective based on the data it finds.
...
For example, the shipping department of Northwind may only need to see orders, products, and customers.
