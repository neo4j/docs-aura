...
See xref::/explore-perspectives/database-scans.adoc[Database scans] for more details.
...
Explore assigns a default color for the category, but you can change the default color and node sizes from the xref::/bloom-visual-tour/legend-panel.adoc[Legend panel].
