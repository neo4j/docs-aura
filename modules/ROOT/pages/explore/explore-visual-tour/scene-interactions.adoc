:description: This section describes Scene interactions in Bloom.
...
Bloom offers an option to group selected nodes and have them represented as one visually distinct larger node.
