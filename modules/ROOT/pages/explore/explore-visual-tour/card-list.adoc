:description: This section describes the card list in Bloom.

[[card-list]]
= Card list

The card list, when expanded, shows details about the currently shown nodes on the scene.
...
Cards in the list can be used to interact with nodes on the scene.
Select one or more cards in the list to select them on scene or vice versa.
