...
If you are migrating from a self-managed instance, you can upload the database dump into a Neo4j Aura instance with:

- the link:https://neo4j.com/docs/operations-manual/current/tools/neo4j-admin/upload-to-aura/[`neo4j-admin database upload`] command (if your instance uses Neo4j 5)
- the link:https://neo4j.com/docs/operations-manual/4.4/tools/neo4j-admin/push-to-cloud/[`neo4j-admin push-to-cloud`] command (if your instance uses Neo4j 4.4 or 4.3)
