...
. Check the breaking changes for each driver you use (for example, check link:https://neo4j.com/docs/api/python-driver/5.0/breaking_changes.html#breaking-changes[this page] for the breaking changes in the Python driver).
. Make sure you switch to the latest version of the driver.
