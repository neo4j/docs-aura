...
The Neo4j BI Connectors available on the link:https://neo4j.com/download-center/#integrations[Download center] and the latest version of the link:https://github.com/neo4j-contrib/neo4j-jdbc/releases/[Neo4j JDBC driver] are compatible with Neo4j 5.
