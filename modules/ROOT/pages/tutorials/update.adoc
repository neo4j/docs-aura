...
* The APOC Library is link:https://neo4j.com/docs/aura/platform/apoc/[supported] in Aura with some exceptions.
* The APOC Extended library is not included in Aura.

For more information on APOC core, check the link:https://neo4j.com/docs/apoc/5/[APOC documentation].
