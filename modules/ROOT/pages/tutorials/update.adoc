...
The Neo4j BI Connectors available on the link:https://neo4j.com/download-center/#integrations[Download center], as well as the latest version of the link:https://github.com/neo4j-contrib/neo4j-jdbc/releases/[Neo4j JDBC driver], are all compatible with Neo4j 5.
...
- With the link:https://neo4j.com/docs/operations-manual/current/tools/neo4j-admin/upload-to-aura/[`neo4j-admin database upload`] command (if your instance uses Neo4j 5)
- With the link:https://neo4j.com/docs/operations-manual/4.4/tools/neo4j-admin/push-to-cloud/[`neo4j-admin push-to-cloud`] command (if your instance uses Neo4j 4.4 or 4.3)
