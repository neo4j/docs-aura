...
There might be some other instances running the same in the same customer Aura environment. 
...
If the your application is running in a different VPC, it will not be able to reach the endpoint. 
