...
This tutorial is cloud agnostic:
...
When you create a private service using the Aura console, the private ingress becomes accessible to all projects within the cloud provider’s VPC. 
