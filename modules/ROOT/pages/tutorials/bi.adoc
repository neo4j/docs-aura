...
After downloading the JDBC driver from the https://neo4j.com/download-center/#integrations[Download Center]:
...
After downloading and installing the ODBC driver from the https://neo4j.com/download-center/#integrations[Download Center]:
