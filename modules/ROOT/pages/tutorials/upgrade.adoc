= Upgrade to Neo4j latest version
...
* The Migration Readiness Report in the Aura console helps Neo4j Aura 4 users assess their usage of Neo4j and easily spot deprecated functionalities in their code.
====
