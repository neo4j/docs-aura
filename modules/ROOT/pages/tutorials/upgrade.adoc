= Update a version 4 instance to the latest version
:description: This tutorial describes how to upgrade an Aura instance running Neo4j version 4 to Neo4j latest.

This tutorial describes how to update an Aura instance running Neo4j 4 to the latest version of Neo4j. 
*Update* will be referred to as *upgrade* from here on, to match terminology used in other documentation.

[NOTE]
====
* There are very few Aura users running version 4. 
...
* The Migration Readiness Report in the Aura console helps Neo4j Aura 4 users assess their usage of Neo4j and easily spot deprecated functionality in their code.
====
