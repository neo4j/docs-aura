= Update a version 4 instance to the latest version of Neo4j
:description: This tutorial describes how to upgrade an Aura instance running Neo4j version 4 to Neo4j latest.

This tutorial describes how to update (referred to as *upgrade* from here on, to match terminology used in other documentation) an Aura instance running Neo4j 4 to the latest version of Neo4j.

[NOTE]
====
* There are still a few Aura users running Neo4j 4. 
If that includes you, we’ll have contacted you directly. 
Otherwise, you’re already up to date.
* New instances are created running the latest version of Neo4j.
* The Migration Readiness Report in the Aura console helps Neo4j Aura 4 users assess their usage of Neo4j and easily spot unsupported features in their code.
====
...
All changes to Cypher, including featre additions, deprecations, and removals, are introduced in Neo4j versions.
...
The following warnings in Neo4j 4.4 have since been changed into....```
