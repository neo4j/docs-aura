...
----
+
For more info see the following migration guide: link:https://neo4j.com/docs/upgrade-migration-guide/current/version-5/migration/[Migrate databases from 4.4 LTS (EOL)]
+
