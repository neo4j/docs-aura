...
Regardless of the issue, viewing the link:/docs/aura/platform/logging/download-logs/[Aura query log] is always recommended to monitor processes and verify any problems.
