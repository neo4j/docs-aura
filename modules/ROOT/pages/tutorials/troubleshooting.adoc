...
. Take the list of commands from the 2nd step, copy them in one list of multiple queries into Browser and run those queries.
...
If you encounter this error, raise a ticket with our link:https://aura.support.neo4j.com/[Customer Support] team.
