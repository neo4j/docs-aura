...
For Neo4j Version 4 Azure instances encrypted with CMK, use Neo4j Data Importer on the Import Tab of Workspace to load data, as `neo4j-admin database upload` is not supported. Please see the https://neo4j.com/docs/data-importer/current/introduction[Data Importer documentation].
====
