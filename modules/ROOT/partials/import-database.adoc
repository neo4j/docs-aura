...
The `neo4j-admin push-to-cloud` command in Neo4j v4.4 and earlier is not compatible with instances encrypted with link:{neo4j-docs-base-uri}//aura/platform/security/#_customer_managed_keys[Customer Managed Keys]. 
