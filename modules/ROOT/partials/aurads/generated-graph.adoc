...
Our graph is going to be nodes with the label `{generated-graph-size}_Nodes` with a relationship of `POWER_LAW`

`(:{generated-graph-size}_Nodes)-[:POWER_LAW]->(:{generated-graph-size}_Nodes)`
