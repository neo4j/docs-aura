...
* Billing
** xref:billing/usage-report.adoc[Usage report]
** xref:billing/usage-based-billing.adoc[Billing dimensions]
** xref:billing/billing-dimensions.adoc[How to pay for Aura]
