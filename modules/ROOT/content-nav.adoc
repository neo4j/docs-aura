...
** xref:managing-instances/instances-explorer.adoc[Instances explorer (Preview feature)]
** xref:managing-instances/multiple-databases.adoc[Multiple databases (Preview feature)]
...
* Manage projects
** xref:managing-projects/create-project.adoc[Create a project]
** xref:managing-projects/delete-and-restore-projects.adoc[Delete and restore projects]

* xref:virtual-graph.adoc[]

* Graph analytics in Aura
** xref:graph-analytics/index.adoc[Overview]
** xref:graph-analytics/aga.adoc[]
** xref:graph-analytics/alternative-deployments.adoc[]
** xref:graph-analytics/migrate-to-aga.adoc[]
...
** xref:import/data-sources.adoc[Data sources]
** xref:import/appendix.adoc[Appendix]
...
* Explore data with Bloom
** xref:explore/introduction.adoc[What is Bloom?]
** xref:explore/explore-quick-start.adoc[Quick start]

** Visual tour
*** xref:explore/explore-visual-tour/explore-overview.adoc[Bloom overview]
...
** xref:dashboards/create-dashboards-with-ai.adoc[Create dashboards with AI]
...
** xref:dashboards/interactivity.adoc[Interactivity]
...
** xref:dashboards/rule-based-styling.adoc[Rule-based styling]
** xref:dashboards/faq-and-resources.adoc[FAQ and resources]

* Document Intelligence (Preview feature)
** xref:document-intelligence/introduction.adoc[What is Document Intelligence?]
** xref:document-intelligence/quick-start.adoc[Quick start]
** xref:document-intelligence/visual-tour.adoc[Visual tour]
** xref:document-intelligence/data-provision.adoc[Data provision]
** xref:document-intelligence/indexes-constraints.adoc[Indexes and constraints]
** xref:document-intelligence/import.adoc[Import]
...
** xref:logging/activity-feed.adoc[Activity feed]
...
* Billing and usage
** xref:billing/cost-explorer.adoc[Cost explorer]
** xref:billing/billing-dimensions.adoc[Billing dimensions]
** xref:billing/payment-options.adoc[Payment options]
...
* xref:support-integration.adoc[Support]
