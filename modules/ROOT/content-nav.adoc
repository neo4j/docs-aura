...
//** xref:document-intelligence/model.adoc[Model data]
//** xref:document-intelligence/extraction.adoc[Extract data]
** xref:document-intelligence/indexes-constraints.adoc[Indexes and constraints]
** xref:document-intelligence/import.adoc[Run the import]
...
* Billing and usage
** xref:billing/usage-report.adoc[Billing and usage report]
